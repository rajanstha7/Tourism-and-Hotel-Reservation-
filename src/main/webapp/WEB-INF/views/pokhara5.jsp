	...
	<head>
		...
		<body>	
			...
			<!-- Pokhara Grande Hotel Descriptions -->
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="resources/img/Hotel/PokharaHotels/5star/pokhara-grande/1.jpg" alt="">
								</div>
								<div class="details">
									<h4 class="d-flex justify-content-between">
										<span>Pokhara Grande</span>                              	
										<div class="star">
									...
									<ul class="package-list">
										...
										<li class="d-flex justify-content-between align-items-center">
											...
											<a href="#" class="price-btn">$125-$200</a>
										</li>	
										<li class="d-flex justify-content-between align-items-center">
											<span>View Details</span>
											<a href="pokharagrande" class="price-btn">Click Here</a>
										</li>														
									</ul>
								</div>
							</div>
			...
			<!--End of Pokhara Grande Descriptions -->
...
The Fulbari Resort & Spa
 -->
			...
			<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="resources/img/Hotel/PokharaHotels/5star/Fulbari Resort/1.jpg" alt="">
								</div>
								<div class="details">
									<h4 class="d-flex justify-content-between">
										<span>The Fulbari Resort </span>                              	
										<div class="star">
											<span class="fa fa-star checked"></span>
											<span class="fa fa-star checked"></span>
											<span class="fa fa-star checked"></span>
			...
			<!--End of The Fulbari Resort & SpaDescriptions -->
