...
<a href ="back">Back</a>
<spring:form action="${pageContext.request.contextPath}/cancelConfirm" method="post" modelAttribute="booking">
	<table>
		...
		<td><spring:input path="checkoutDate"readonly="true" ></spring:input></td>
		</tr>
