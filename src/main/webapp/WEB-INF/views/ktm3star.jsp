	...
	<head>
		...
		<body>	
			...
			<!--End of Hotel Mananga Descriptions -->
			<!-- Hotel Airport -->
			
			<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="resources/img/Hotel/Hotels Kathmandu/3 Star Hotels/Airport Hotel/hotelairport.jpg" alt="">
								</div>
								<div class="details">
									<h4 class="d-flex justify-content-between">
									...
									<ul class="package-list">
										...
										<li class="d-flex justify-content-between align-items-center">
											<span>Price per night</span>
											<a href="#" class="price-btn">$100-$220</a>
										</li>													
									</ul>
								</div>
							</div>
			...
			<!--End of Airport HotelDescriptions -->
			...
			<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="resources/img/Hotel/Hotels Kathmandu/3 Star Hotels/Hotel Mulberry/hotel-mullberry.jpg" alt="">
								</div>
								<div class="details">
									<h4 class="d-flex justify-content-between">
										<span>Hotel Mulberry</span>                              	
										<div class="star">
											<span class="fa fa-star checked"></span>
											<span class="fa fa-star checked"></span>
											<span class="fa fa-star checked"></span>
									...
									<ul class="package-list">
										...
										<li class="d-flex justify-content-between align-items-center">
											<span>Price per night</span>
											<a href="#" class="price-btn">$100-$300</a>
										</li>													
									</ul>
								</div>
							</div>
