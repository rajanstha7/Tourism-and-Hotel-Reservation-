	...
	<head>
		...
		<body>	
			...
			<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="resources/img/Hotel/Hotels Kathmandu/2 Star Hotels/Tibet Peace inn/1.jpg" alt="">
								</div>
								<div class="details">
									<h4 class="d-flex justify-content-between">
										<span>Tibet Peace inn</span>                              	
										<div class="star">
											<span class="fa fa-star checked"></span>
											<span class="fa fa-star checked"></span>
									...
									<ul class="package-list">
										...
										<li class="d-flex justify-content-between align-items-center">
											<span>Price per night</span>
											<a href="#" class="price-btn">$100-$200</a>
										</li>	
										
											<li class="d-flex justify-content-between align-items-center">
											<span>View Details</span>
											<a href="Tibet Peace inn" class="price-btn">Click Here</a>
										</li>		
	...
	<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="resources/img/Hotel/Hotels Kathmandu/2 Star Hotels/Hotel Pamilo House/1.jpg" alt="">
								</div>
								<div class="details">
									<h4 class="d-flex justify-content-between">
										<span>Hotel Pamilo House</span>                              	
										<div class="star">
											<span class="fa fa-star checked"></span>
											<span class="fa fa-star checked"></span>
									...
									<ul class="package-list">
										...
										<li class="d-flex justify-content-between align-items-center">
											<span>Price per night</span>
											<a href="#" class="price-btn">$50-$150</a>
										</li>	
										
											<li class="d-flex justify-content-between align-items-center">
											<span>View Details</span>
											<a href="Hotel Pamilo House" class="price-btn">Click Here</a>
										</li>		
	...
	<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="resources/img/Hotel/Hotels Kathmandu/2 Star Hotels/Potala Guest House/1.jpg" alt="">
								</div>
								<div class="details">
									<h4 class="d-flex justify-content-between">
										<span>Potala Guest House</span>                              	
										<div class="star">
											<span class="fa fa-star checked"></span>
											<span class="fa fa-star checked"></span>
									...
									<ul class="package-list">
										...
										<li class="d-flex justify-content-between align-items-center">
											<span>Price per night</span>
											<a href="#" class="price-btn">$90-$200</a>
										</li>	
										
											<li class="d-flex justify-content-between align-items-center">
											<span>View Details</span>
											<a href="Potala Guest House" class="price-btn">Click Here</a>
										</li>		
