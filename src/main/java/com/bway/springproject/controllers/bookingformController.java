...
public class bookingformController {
	...
	public String getbookingformm1(@ModelAttribute Booking bok ,Model model) {
		...
		String msg = "Dear Customer, "+"   "+"Your Booked Hotel Room Information :"+"      "+"Hotel Name :  "+bok.getHotelName()+"     "+"Room No :"+bok.getRoomno()+"       "+"Room Type:"+bok.getRoomType()+"      "+"Booking Date:"+bok.getBookingDate()+"     "+ "Checkout Date:"+bok.getCheckoutDate()+  "Thank you for booking!!!"+"  "+"  Enjoy your Day";
